...
- Registry Name: acrforaksdemo11   (NAME should be unique across Azure Cloud)
- Location: Central US
...
- Go to Services -> Container Registries -> acrforaksdemo11
- Go to **Access Keys**
...
```
# Export Command
export ACR_REGISTRY=acrforaksdemo11.azurecr.io
...
docker tag kube-nginx-acr:v1 acrforaksdemo11.azurecr.io/app1/kube-nginx-acr:v1
...
```
#Set ACR NAME
export ACR_NAME=acrforaksdemo11
echo $ACR_NAME
...
az aks update -n akscluster -g aks-rg --attach-acr $ACR_NAME
```
    ...
    spec:
      containers:
        - name: acrdemo-localdocker
          image: acrforaksdemo11.azurecr.io/app1/kube-nginx-acr:v1
