...
## Step-01: Create Azure Database for MySQL servers
...
- **Server Details**
  - Server name: akswebdb (This name is based on availability - in your case it might be something else)
  - Data source: none
  - Location: (US) East US
  - Version: 5.7 (default)
  - **Compute + Storage**
...
- **Settings -> Connection Security**
  ...
  - Click on **Save**
- It will take close to 5 minutes for changes to take place. 
...
spec:
  type: ExternalName
  externalName: akswebdb.mysql.database.azure.com
```
 - **Deploy Manifest**
```
